...
export const Card = ({
  ...
  return (
    <div
      onClick={() => onClick(id)}
      className={cn(
        "h-fulll flex min-h-[217px] min-w-[200px] cursor-pointer flex-col  items-center justify-between rounded-xl border-2 border-b-4 p-3 pb-6 hover:bg-black/5 active:border-b-2",
